...
var ns_groundwater_reliance = {
  ...
  init: function(){
    ...
    var colorReliance = d3.scaleLinear()
    .domain([0,0.25,0.5])
    .range(['#f5f5f5', '#D5B5B5','#8b0000'])
        ...
        d3.json(tws_url, function(error, tws){
          d3.csv(water_use_csv_url, function(error, data_water_use){
            ...
            data_water_use.forEach(function(d){
              data_groundwater_reliance[d.Province] = d['Total Amount of Groundwater Supply']/d['Total Amount of Water Supply'];
            });
            ...
            .style('fill', function(d){
              return colorReliance(data_groundwater_reliance[d.properties.NAME_1]);
            })
            ...
            legend_reliance.selectAll(".legend-square")
            .data(['0','0.125','0.25','0.375','0.5'])
            .enter()
            .append("rect")
            ...
            .attr("width", 15)
            .attr("height", 15)
            .style("fill", function(d) { return colorReliance(d); });

            legend_reliance.selectAll(".legend-label")
            .data(['0', '25%', '>50%'])
            .enter()
            .append("text")
